...
LogicRegions = {
    ...
    Regions.LlamaTemple: Region("Llama Temple", HintRegion.LlamaTemple, Levels.AngryAztec, True, -1, [
        ...
        LocationLogic(Locations.AztecLankyLlamaTempleBarrel, lambda l: l.trombone and ((l.handstand and l.islanky) or (l.settings.free_trade_items and ((l.istiny and ((l.twirl and l.monkey_maneuvers) or (l.slope_resets and not l.isKrushaAdjacent(Kongs.tiny)))) or l.CanMoonkick()))), MinigameType.BonusBarrel),
