...
LogicRegions = {
    ...
    Regions.UpperCore: Region("Upper Core", HintRegion.ProductionRoom, Levels.FranticFactory, False, None, [
        ...
        LocationLogic(Locations.FactoryLankyProductionRoom, lambda l: Events.LankyCoreSwitch in l.Events and Events.MainCoreActivated in l.Events and (l.handstand and l.lanky) or (l.tiny and l.settings.free_trade_items and l.slope_resets and not l.isKrushaAdjacent(Kongs.tiny))),
